...
import { Scale, BarPlot, PlotContext, changeOrder, orderBarsByMagnitude, BAR_PLOT_DEFAULT_TEMPLATE } from '@bezda/rhp-core';
...
export const BarPlotExampleNI = () => {
  ...
  useMemo(() => {
    plotData.set([[10], [3], [18], [6], [25], [13], [20]]);
    dataMax.set(30);
    vars.set({
  ...
  const trackedBarsData = useObservable(() => {
    ...
    untrackedData.forEach((value, i) => {
        newBarsDataTemp.push({
                              ...
                              decorationWidth: "8rem",
                              elements: opaqueObject(BAR_PLOT_DEFAULT_TEMPLATE),  // Avoid strange unexplainable circular reference errors for each element of this array on first render
